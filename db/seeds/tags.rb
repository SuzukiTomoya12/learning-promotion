...
development_child_array = [
  {name: "プログラミング", description: "アプリケーションやソフトウェア開発に関わるプログラミングを学びます。", image: File.open("./app/assets/images/tags/development/development.jpg")},
  {name: "開発ツール", description: "開発に便利なツールの使い方を学びます。", image: "tags/development/development.jpg"},
  {name: "データベース", description: "SQLなどを学ぶことができます。", image: ""},
  {name: "データサイエンス", description: "ビッグデータの活用方法などを学ぶことができます。", image: ""},
  {name: "ゲーム開発", description: "ゲームの開発に関する知識を学ぶことができます。", image: ""}
]
